...
describe("export", function()
   ...
   it("write_json produces a file containing valid JSON with envelope keys", function()
      ...
      local results = {
         {
            ...
            targets = {
               {
                  name = "v1", median = 0.001, ci_lower = 0.0009,
                  ci_upper = 0.0011, rounds = 100, rank = 1, ratio = 1.0,
               },
            },
         },
      }
      ...
      local ok = export.write_json(filepath, results, targets, "0.3.0")
   ...
   it("write_json envelope contains the provided version string", function()
      ...
      export.write_json(filepath, {}, {}, "1.2.3")
   ...
   it("write_json targets array maps target names correctly", function()
      ...
      export.write_json(filepath, {}, targets, "0.3.0")
      ...
      local results = {
         {
            ...
            targets = {
               ...
               {
                  name = "v2", median = 0.002, ci_lower = 0.0018,
                  ci_upper = 0.0022, rounds = 100, rank = 2, ratio = 2.0,
               },
            },
         },
      }

      export.write_json(filepath, results, {}, "0.3.0")
