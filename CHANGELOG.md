...
- CLI simplified: targets are now positional arguments to `luapit` directly instead of requiring the
  `ref` subcommand (`luapit .#main .#dev` replaces `luapit ref .#main .#dev`)
